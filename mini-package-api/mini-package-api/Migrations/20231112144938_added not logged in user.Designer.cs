...
namespace mini_package_api.Migrations
{
    ...
    [Migration("20231112144938_added not logged in user")]
    partial class addednotloggedinuser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mini_package_api.Models.Inquire", b =>
                {
                    b.HasOne("mini_package_api.Models.ClientAddress", "DestinationUserAddress")
                        .WithMany("DestinationInquires")
                        .HasForeignKey("DestinationAddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("mini_package_api.Models.ClientAddress", "SourceUserAddress")
